              ...
              <div class="flex">
                <template x-for="image in images">
                  <a
                    ...
                    class="cursor-pointer w-[80px] h-[80px] mt-1 border border-gray-300 hover:border-purple-500 flex items-center justify-center"
                    :class="{'border-purple-600': activeImage === image}"
                  >
                    <img
                      :src="image"
                      alt=""
                      class="w-auto max-auto max-h-full"
                    />
                  </a>
                </template>
              </div>
